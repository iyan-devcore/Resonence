...
-- CreateEnum
CREATE TYPE "VoiceCategory" AS ENUM ('AUDIOBOOK', 'CONVERSATIONAL', 'CUSTOMER_SERVICE', 'GENERAL', 'NARRATIVE', 'CHARACTER', 'MEDITATION', 'MOTIVETIONAL', 'PODCAST', 'ADVERTISING', 'VOICEOVER', 'CORPORATE');
