...
import { VoicePreviewMobileVoice } from "../components/voice-preview-mobile";
...
export function TextToSpeechDetailView({
    ...
    const resolvedVoiceId = data?.voiceId && allVoices.some((v) => v.id === data.voiceId)
        ? data.voiceId
        : fallbackVoiceId;
