        ...
        : hasMissingSelectedVoice
            ...
            return(
                <Field>
                    ...
                    <Select value={voiceId} onValueChange={(v) => form.setFieldValue("voiceId", v)} disabled={isSubmitting}>
                        ...
                        <SelectContent>
                                ...
                                <SelectGroup>
                                    ...
                                    {customVoices.map((v) => (
                                        <SelectItem key={v.id} value={v.id}>
                                            <VoiceAvatar seed={v.id} name={v.id} />
                                            <span className="truncate text-sm font-medium">
                            ...
                            {systemVoices.length > 0 && systemVoices.length > 0 && (
                                <SelectSeparator />
                            )}
