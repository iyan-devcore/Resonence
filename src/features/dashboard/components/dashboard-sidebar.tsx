...
import { 
    Sidebar,SidebarContent,SidebarFooter,SidebarGroup,SidebarGroupContent,SidebarGroupLabel,SidebarHeader,SidebarMenu,SidebarMenuButton,SidebarMenuItem,SidebarRail,SidebarTrigger 
...
export function DashboardSidebar(){
    ...
    const othersMenuItems: MenuItem[] = [
        ...
        },
        {
            ...
            url: "mailto:memoniyan@gmail.com",
            icon: Headphones,
        },
    ];
